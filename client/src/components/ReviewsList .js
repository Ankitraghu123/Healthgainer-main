...
<<<<<<< HEAD
  ...
  const options = [
    ...
    // { label: "Only Pictures", icon: <FaImage className="text-primary mr-2" /> },
    // { label: "Pictures First", icon: <FaImage className="text-primary mr-2" /> },
    // { label: "Videos First", icon: <FaVideo className="text-primary mr-2" /> },
    // { label: "Most Helpful", icon: <FaThumbsUp className="text-primary mr-2" /> },
  ];

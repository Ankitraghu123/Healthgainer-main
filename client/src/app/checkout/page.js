  ...
  const handlePlaceOrder = () => {
    ...
    dispatch(placeOrder(orderData)).then((action) => {
      ...
      if (action.payload?._id) {
        console.log(
          "Navigating to:",
          `/orderConfirmation/${action.payload._id}`
        );
            ...
            <div className='bg-white p-6 rounded-lg shadow'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
                <button
                  ...
                  className={`flex items-center justify-center gap-2 px-4 py-3 rounded border ${
                    paymentMethod === "COD"
          ...
          <div className='space-y-6'>
            <div className='bg-white p-6 rounded-lg shadow'>
              ...
              <div className='space-y-4'>
                {cartItems.map((item) => {
                  const itemDiscount =
                    item.mrp * item.quantity - item.price * item.quantity;
                  return (
              ...
              >
                ...
                {orderLoading ? "Processing..." : <CheckoutButton />}
              </button>
            </div>
          </div>
        </div>

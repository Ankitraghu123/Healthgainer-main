...
import { FiEdit, FiUser, FiMail, FiPhone, FiCalendar, FiMapPin } from "react-icons/fi";
...
export default function ProfilePage() {
    ...
    const { profilePhoto, email, mobileNumber, firstName, lastName, createdAt } = userData;
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    {userData.addresses && userData.addresses.length > 0 ? (
                                        <p className="text-gray-900">{userData.addresses.length} saved addresses</p>
                                    ) : (

...
//     try {
//       // Dispatch the createVariant action with FormData
//       await dispatch(createVariant({ id, formData })).unwrap();
//       toast.success( "Varient created successfully!");
//       router.push(`/admin/products/${id}`); // Redirect back to the product page
//     } catch (error) {
...
//         <button
//           type="submit"
//           className="mt-6 bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-800 transition-colors duration-200"
//         >
//           Add Variants
//         </button>
//       </form>

            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 border-b">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-md">
                  ...
                  <p className="mt-2 text-gray-700"><span className="font-medium">Phone:</span> {order.address.phone}</p>
                </div>
              </div>
              <div>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            {item.productId.images?.length > 0 && (
                              <img src={item.productId.images[0]} className="h-12 w-12 rounded-md object-cover border" />
                            )}
                            <div className="ml-4">
                              <div className="font-medium">{item.productId.name}</div>
                              <div className="text-xs text-gray-500">{item.productId.description.substring(0, 60)}...</div>
                              {item.variantId && (
                                <div className="mt-1">
              ...
              <div className="max-w-md ml-auto">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-t pt-3 flex justify-between font-bold text-lg">
                    ...
                    <span>₹{(order.totalAmount * 1.12).toLocaleString('en-IN')}</span>
                  </div>
                </div>
              </div>
            </div>

...
//                 <h1 className="text-4xl font-bold text-gray-800">Explore <span className="text-primary">Our Products</span></h1>
//                 <p className="text-lg text-gray-600 mt-2">Premium health gainers designed for your fitness journey</p>
//             </div>
...
//                             <img src={product.images[0]} alt={product.name} className="h-full py-2" />
//                             <span className="absolute top-2 left-2 bg-primary text-white text-xs font-bold px-3 py-1 rounded-full">{product.discount}% OFF</span>
//                         </div>
...
//                             </div>
//                             <motion.button
//                                 className="mt-6 w-full px-6 py-3 rounded-lg text-white font-semibold shadow-lg bg-gradient-to-r from-[#ff8c00] to-[#ff4500] hover:from-[#ff4500] hover:to-[#ff8c00] transform hover:scale-105 transition-all duration-500 ease-in-out"
...
export default function ProductGallery() {
    ...
    const handleAddToCart = async (product) => {
        ...
        const userId = "user123"; // Replace with actual userId if using auth
                        ...
                        <div className="p-5 text-center">
                            ...
                            <motion.button
                                className={`mt-6 w-full px-6 py-3 rounded-lg text-white font-semibold shadow-lg bg-gradient-to-r from-[#ff8c00] to-[#ff4500] hover:from-[#ff4500] hover:to-[#ff8c00] transform transition-all duration-500 ease-in-out ${
                                    loadingProductId === product._id ? 'opacity-70 cursor-not-allowed' : ''
                                }`}
                                whileHover={{ scale: loadingProductId === product._id ? 1 : 1.1 }}
                                whileTap={{ scale: 0.95 }}
